...
public class PCSimulatorBody : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        cursorState.Push(new CursorState(CursorLockMode.Locked, false));
    }
    ...
    private void OnDisable()
    {
        ...
        {
            CursorState last = cursorState.Peek();
            Cursor.lockState = last.lockMode;
            Cursor.visible = last.visible;
        }
    ...
    struct CursorState
    {
        ...
        public CursorState(CursorLockMode mode, bool v)
        {
            lockMode = mode;
            visible = v;
        }
    ...
    static Stack<CursorState> cursorState = new Stack<CursorState>();
